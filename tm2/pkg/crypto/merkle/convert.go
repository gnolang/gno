...
func ConvertExistenceProof(p *SimpleProof, key, value []byte) (*ics23.ExistenceProof, error) {
...
func convertInnerOps(p *SimpleProof) ([]*ics23.InnerOp, error) {
...
func buildPath(idx, total int) []bool {
	if total < 2 {
		return nil
	}
