...
// Partially copied from baseApp, to simulate such as msg injection
// TODO: or inject Txs instead?
type MockApp struct {
...
func (app *MockApp) Name() string {
	return app.name
}

// AppVersion returns the application's version string.
func (app *MockApp) AppVersion() string {
	return app.appVersion
}

// Logger returns the logger of the BaseApp.
func (app *MockApp) Logger() log.Logger {
	return app.logger
}

// MountStoreWithDB mounts a store to the provided key in the BaseApp
// multistore, using a specified DB.
func (app *MockApp) MountStoreWithDB(key store.StoreKey, cons store.CommitStoreConstructor, db dbm.DB) {
	app.cms.MountStoreWithDB(key, cons, db)
}

// MountStore mounts a store to the provided key in the BaseApp multistore,
// using the default DB.
func (app *MockApp) MountStore(key store.StoreKey, cons store.CommitStoreConstructor) {
...
func (app *MockApp) LoadLatestVersion() error {
...
func (app *MockApp) LoadVersion(version int64) error {
...
func (app *MockApp) LastCommitID() store.CommitID {
...
func (app *MockApp) initFromMainStore() error {
	...
	// Not sealing here for test
	// app.Seal()

	return nil
}

func (app *MockApp) setMinGasPrices(gasPrices []GasPrice) {
	app.minGasPrices = gasPrices
}

func (app *MockApp) setHaltHeight(haltHeight uint64) {
	app.haltHeight = haltHeight
}

func (app *MockApp) setHaltTime(haltTime uint64) {
	app.haltTime = haltTime
}

// Returns a read-only (cache) MultiStore.
// This may be used by keepers for initialization upon restart.
func (app *MockApp) GetCacheMultiStore() store.MultiStore {
	return app.cms.MultiCacheWrap()
}

// Router returns the router of the BaseApp.
func (app *MockApp) Router() Router {
	if app.sealed {
...
func (app *MockApp) Seal() { app.sealed = true }

// IsSealed returns true if the BaseApp is sealed and false otherwise.
func (app *MockApp) IsSealed() bool { return app.sealed }

// setCheckState sets checkState with the cached multistore and
// the context wrapping it.
// It is called by InitChain() and Commit()
func (app *MockApp) setCheckState(header abci.Header) {
...
func (app *MockApp) setDeliverState(header abci.Header) {
	ms := app.cms.MultiCacheWrap()
...
func (app *MockApp) setConsensusParams(consensusParams *abci.ConsensusParams) {
	app.consensusParams = consensusParams
}

// setConsensusParams stores the consensus params to the main store.
func (app *MockApp) storeConsensusParams(consensusParams *abci.ConsensusParams) {
...
// one.
func (app *MockApp) getMaximumBlockGas() int64 {
...
func (app *MockApp) Info(req abci.RequestInfo) (res abci.ResponseInfo) {
...
func (app *MockApp) SetOption(req abci.RequestSetOption) (res abci.ResponseSetOption) {
	// TODO: Implement!
	return
}
...
func (app *MockApp) InitChain(req abci.RequestInitChain) (res abci.ResponseInitChain) {
...
func (app *MockApp) validateHeight(req abci.RequestBeginBlock) error {
...
func (app *MockApp) BeginBlock(req abci.RequestBeginBlock) (res abci.ResponseBeginBlock) {
...
func (app *MockApp) CheckTx(req abci.RequestCheckTx) (res abci.ResponseCheckTx) {
	var tx Tx
...
func (app *MockApp) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
	var tx Tx
	err := amino.Unmarshal(req.Tx, &tx)
	if err != nil {
		res.Error = ABCIError(std.ErrTxDecode(err.Error()))
...
func (app *MockApp) getContextForTx(mode RunTxMode, txBytes []byte) (ctx Context) {
...
func (app *MockApp) runMsgs(ctx Context, msgs []Msg, mode RunTxMode) (result Result) {
...
func (app *MockApp) getState(mode RunTxMode) *state {
...
func (app *MockApp) cacheTxContext(ctx Context, txBytes []byte) (
...
// documentation.
func (app *MockApp) runTx(mode RunTxMode, txBytes []byte, tx Tx) (result Result) {
...
func (app *MockApp) EndBlock(req abci.RequestEndBlock) (res abci.ResponseEndBlock) {
...
// height.
func (app *MockApp) Commit() (res abci.ResponseCommit) {
