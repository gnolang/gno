...
func init() {
	...
	amino.RegisterGenproto2Type(reflect.TypeOf((*MultiTransferEvent)(nil)).Elem())
}
...
func (goo Input) MarshalBinary2(cdc *amino.Codec, buf []byte, offset int) (int, error) {
	var err error
	{
...
func (goo Input) SizeBinary2(cdc *amino.Codec) (int, error) {
	var s int
	{
		repr, err := goo.Address.MarshalAmino()
		if err != nil {
...
func (goo *Input) UnmarshalBinary2(cdc *amino.Codec, bz []byte, anyDepth int) error {
	*goo = Input{}
	var lastFieldNum uint32
	for len(bz) > 0 {
		fnum, typ3, n, err := amino.DecodeFieldNumberAndTyp3(bz)
		...
		default:
			return fmt.Errorf("unknown field number %d for Input", fnum)
		}
	}
	return nil
}

func (goo Output) MarshalBinary2(cdc *amino.Codec, buf []byte, offset int) (int, error) {
	var err error
	{
		repr, err := goo.Coins.MarshalAmino()
		if err != nil {
...
func (goo Output) SizeBinary2(cdc *amino.Codec) (int, error) {
	var s int
	{
		repr, err := goo.Address.MarshalAmino()
		if err != nil {
...
func (goo *Output) UnmarshalBinary2(cdc *amino.Codec, bz []byte, anyDepth int) error {
	*goo = Output{}
	var lastFieldNum uint32
	for len(bz) > 0 {
		fnum, typ3, n, err := amino.DecodeFieldNumberAndTyp3(bz)
		...
		default:
			return fmt.Errorf("unknown field number %d for Output", fnum)
		}
	}
	return nil
}
...
func (goo MultiTransferEvent) MarshalBinary2(cdc *amino.Codec, buf []byte, offset int) (int, error) {
	var err error
...
func (goo MultiTransferEvent) SizeBinary2(cdc *amino.Codec) (int, error) {
	var s int
...
func (goo *MultiTransferEvent) UnmarshalBinary2(cdc *amino.Codec, bz []byte, anyDepth int) error {
	*goo = MultiTransferEvent{}
	var lastFieldNum uint32
	for len(bz) > 0 {
		fnum, typ3, n, err := amino.DecodeFieldNumberAndTyp3(bz)
		_ = typ3
		...
		default:
			return fmt.Errorf("unknown field number %d for MultiTransferEvent", fnum)
		}
	}
	return nil
}
