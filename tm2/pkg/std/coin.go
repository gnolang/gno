...
var (
	reDnmString = `[a-z][a-z0-9/:._-]{2,127}` // cosmos regex(https://github.com/cosmos/cosmos-sdk/blob/b2c26cdc4c3d2f5b7cb28e5153e2b458c61ee8fa/types/coin.go#L852) without captial letters
	reAmt       = `[[:digit:]]+`
	reSpc       = `[[:space:]]*`
