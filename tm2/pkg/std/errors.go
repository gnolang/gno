...
type (
	...
	SessionAlreadyExistsError struct{ abciError }
	SessionIsMasterError      struct{ abciError }
	SessionIsInvalidError     struct{ abciError }
)
...
func (e SessionAlreadyExistsError) Error() string { return "session already exists error" }
func (e SessionIsMasterError) Error() string      { return "session is master error" }
func (e SessionIsInvalidError) Error() string     { return "session is invalid error" }
...
func ErrSessionAlreadyExists(msg string) error {
	return errors.Wrap(SessionAlreadyExistsError{}, msg)
}

func ErrSessionIsMaster(msg string) error {
	return errors.Wrap(SessionIsMasterError{}, msg)
}

func ErrSessionIsInvalid(msg string) error {
	return errors.Wrap(SessionIsInvalidError{}, msg)
}
