...
func newTestDB(t *testing.T) *MDBX {
	t.Helper()
	name := fmt.Sprintf("test_%x", internal.RandStr(12))
	db, err := NewMDBX(name, t.TempDir())
...
func TestMDBXNewWithOptions(t *testing.T) {
	t.Parallel()
	name := fmt.Sprintf("test_%x", internal.RandStr(12))
	db, err := NewMDBXWithOptions(name, t.TempDir(), 10<<20, 0)
	require.NoError(t, err)
...
func TestMDBXOpenExisting(t *testing.T) {
	t.Parallel()
	dir := t.TempDir()
	name := "reopen"

	db1, err := NewMDBX(name, dir)
	require.NoError(t, err)
	require.NoError(t, db1.Set([]byte("persist"), []byte("yes")))
	require.NoError(t, db1.Close())

	db2, err := NewMDBX(name, dir)
	require.NoError(t, err)
	defer db2.Close()
...
func TestMDBXOpenBadDir(t *testing.T) {
	t.Parallel()
	_, err := NewMDBX("test", "/dev/null/impossible")
	require.Error(t, err)
}

func TestMDBXRegistry(t *testing.T) {
	t.Parallel()
	d, err := db.NewDB("regtest", MDBXBackend, t.TempDir())
	require.NoError(t, err)
...
func TestMDBXDoubleClose(t *testing.T) {
	t.Parallel()
	name := fmt.Sprintf("test_%x", internal.RandStr(12))
	db, err := NewMDBX(name, t.TempDir())
	require.NoError(t, err)
...
func TestMDBXUseAfterClose(t *testing.T) {
	t.Parallel()
	name := fmt.Sprintf("test_%x", internal.RandStr(12))
	db, err := NewMDBX(name, t.TempDir())
	require.NoError(t, err)
...
func TestMDBXBatchWriteOnClosedDB(t *testing.T) {
	t.Parallel()
	name := fmt.Sprintf("test_%x", internal.RandStr(12))
	db, err := NewMDBX(name, t.TempDir())
	require.NoError(t, err)
...
func TestMDBXGetSetDelete(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXSetSync(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXDeleteSync(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
	require.NoError(t, db.Set([]byte("k"), []byte("v")))
...
func TestMDBXNilAndEmptyKeys(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXNilAndEmptyValues(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXGetReturnsCopy(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXSetDoesNotRetainInput(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXMultipleGetsReturnIndependentCopies(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatch(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchAtomic(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchOverwriteInBatch(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchSetThenDeleteInBatch(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchDeleteThenSetInBatch(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchEmptyWrite(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchGetByteSize(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchWriteSync(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchWithSize(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchNilKey(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchUseAfterWrite(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchUseAfterClose(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchDoubleClose(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXBatchCloseDiscardsWrites(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXCloseBlocksUntilIteratorClosed(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXIteratorForward(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXIteratorReverse(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXIteratorEmptyDB(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXIteratorDomain(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
	require.NoError(t, db.Set([]byte("a"), []byte("1")))
...
func TestMDBXIteratorReturnsCopies(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXIteratorValues(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXIteratorCloseReleasesResources(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXIteratorSingleKey(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXIteratorError(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
	require.NoError(t, db.Set([]byte("a"), []byte("1")))
...
func TestMDBXIteratorDoubleClose(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXIteratorNextPanicsOnInvalid(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXIteratorKeyPanicsOnInvalid(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXIteratorUseAfterClose(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXSentinelKeyNoCollision(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXSentinelKeyIteratorOrder(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXSentinelKeyDistinctFromMultiByte(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXConcurrentReads(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXConcurrentIterators(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXConcurrentWrites(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXLargeValues(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXLargeKey(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXManyKeys(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXManyKeysBatch(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXStats(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func TestMDBXPrint(t *testing.T) {
	t.Parallel()
	db := newTestDB(t)
...
func BenchmarkMDBXIterator(b *testing.B) {
	if testing.Short() {
		b.Skip("skipping testing in short mode")
	}
	name := fmt.Sprintf("test_%x", internal.RandStr(12))
...
func BenchmarkMDBXBatchWrites(b *testing.B) {
	if testing.Short() {
		b.Skip("skipping testing in short mode")
	}
	name := fmt.Sprintf("test_%x", internal.RandStr(12))
