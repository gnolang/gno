...
import "github.com/gnolang/gno/gno/stdlibs/std"
			...
			expectedImports: []*ast.ImportSpec{
				{
					Path: &ast.BasicLit{
						ValuePos: 21,
						Kind:     9,
						Value:    `"github.com/gnolang/gno/gno/stdlibs/std"`,
					},
				},
			},
		},
...
import bar "github.com/gnolang/gno/gno/stdlibs/std"
...
import "github.com/gnolang/gno/gno/stdlibs/regexp"
			...
			expectedImports: []*ast.ImportSpec{
				{
					Path: &ast.BasicLit{
						ValuePos: 21,
						Kind:     9,
						Value:    `"github.com/gnolang/gno/gno/stdlibs/regexp"`,
					},
				},
			},
		},
