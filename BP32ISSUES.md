...
- **Reachable leaks/robustness remaining: ~5** (Tier B: L1/L2/L5/L6, M8); **M15** ⚠️ documented-contract (structural fix deferred to state-sync). ✅ H11/H13 (`568bc03b6`); **M9** + L3 via #5591 (§VI); ✅ **L7** (`8208eb3c1`, Import rolls back pending state).
