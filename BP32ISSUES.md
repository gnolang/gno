...
- **Reachable leaks/robustness remaining: 1** (Tier B: L5 cache-evict-before-flush — likely harmless post-H2/H3, pending a verify-and-downgrade pass); **M15** ⚠️ documented-contract (structural fix deferred to state-sync). ✅ H11/H13 (`568bc03b6`); **M9** + L3 via #5591 (§VI); ✅ **L7** (`8208eb3c1`); ✅ **L1/L6/M8** (`1db08015f`); ✅ **L2** (`fc5451526`).
