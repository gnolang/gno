...
Boards2 provides a custom `Permissions` implementation in [gno.land/r/gnoland/boards2/v0/permissions] that
...
[gno.land/r/gnoland/boards2/v0/permissions] realm, which exposes the underlying DAO.
...
[permissions file]: https://gno.land/r/gnoland/boards2/v0$source&file=permissions.gno
[gno.land/r/gnoland/boards2/v0/permissions]: https://gno.land/r/gnoland/boards2/v0/permissions/
