...
func Gno2Go(fset *token.FileSet, f *ast.File) (string, error) {
	...
	if err != nil {
		return "", fmt.Errorf("gno2go ast: %w", err)
	}

	_, err = out.WriteString("// Code generated by a tool. DO NOT EDIT.\n\n")
	if err != nil {
...
func gno2GoAST(fset *token.FileSet, f *ast.File) (ast.Node, error) {
	var errs error
