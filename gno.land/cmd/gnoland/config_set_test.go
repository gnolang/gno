...
// testEditCase outlines the single test case for config edit
type testEditCase struct {
	name     string
	flags    []string
	verifyFn func(*config.Config, string)
}

// verifyEditTestTableCommon is the common test table
// verification for config edit test cases
func verifyEditTestTableCommon(t *testing.T, testTable []testEditCase) {
	t.Helper()
...
func TestConfig_Edit_Invalid(t *testing.T) {
	t.Parallel()
...
func TestConfig_Edit_Base(t *testing.T) {
	t.Parallel()

	testTable := []testEditCase{
		{
			"root dir updated",
			[]string{
				"RootDir",
	...
	verifyEditTestTableCommon(t, testTable)
}

func TestConfig_Edit_Consensus(t *testing.T) {
	t.Parallel()
...
func TestConfig_Edit_Events(t *testing.T) {
	t.Parallel()
...
func TestConfig_Edit_P2P(t *testing.T) {
	t.Parallel()
...
func TestConfig_Edit_RPC(t *testing.T) {
	t.Parallel()
...
func TestConfig_Edit_Mempool(t *testing.T) {
	t.Parallel()
