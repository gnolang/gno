...
cat $SRC | grep "caller\":\"$JAE_ADDR" | grep 'gno.land/r/archives/boards","func":"CreateThread","args":\["1"' | sed "s/$JAE_ADDR/$ADMIN_ADDR/" >> $TARGET
cat $SRC | grep "caller\":\"$ADMIN_ADDR" | grep 'gno.land/r/archives/boards","func":"CreateThread","args":\["1"' >> $TARGET
