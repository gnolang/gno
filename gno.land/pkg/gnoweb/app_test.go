...
func TestRoutes(t *testing.T) {
	var (
		...
		routes = []struct {
			...
			{"/r/tests/tests/deep/very/deep", ok, "it works!"},
			{"/r/tests/tests/deep/very/deep?arg1=val1&arg2=val2", ok, "hi ?arg1=val1&amp;arg2=val2"},
			{"/r/tests/tests/deep/very/deep:bob", ok, "hi bob"},
			{"/r/tests/tests/deep/very/deep:bob?arg1=val1&arg2=val2", ok, "hi bob?arg1=val1&amp;arg2=val2"},
			{"/r/tests/tests/deep/very/deep$help", ok, "Render"},
			{"/r/tests/tests/deep/very/deep/", ok, "render.gno"},
			{"/r/tests/tests/deep/very/deep/render.gno", ok, ">package<"},
