class SearchBar {
  ...
  private init(): void {
    ...
    this.DOM.inputSearch = el?.querySelector<HTMLInputElement>(SearchBar.SELECTORS.inputSearch) ?? null;
    this.DOM.breadcrumb = el?.querySelector<HTMLElement>(SearchBar.SELECTORS.breadcrumb) ?? null;
