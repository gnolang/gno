...
func LoadPackage(memPkg *std.MemPackage, creator bft.Address, fee std.Fee, deposit std.Coins) (std.Tx, error) {
	var tx std.Tx
	...
	// XXX MANFRED
	fmt.Printf("@@@ mempkg=%v creator=%v fee=%v\n", memPkg, creator, fee)
	for _, file := range memPkg.Files {
		fmt.Println("AAA", file.Name, file.Body)
	}
