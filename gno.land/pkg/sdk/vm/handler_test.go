...
func TestVmHandlerQuery_Funcs(t *testing.T) {
	tt := []struct {
		...
		// valid queries
		{input: []byte(`gno.land/r/hello`), expectedResult: `[{"FuncName":"Panic","Params":[],"Results":[]},{"FuncName":"Echo","Params":[{"Name":"msg","Type":"string","Value":""}],"Results":[{"Name":".res.0","Type":"string","Value":""}]},{"FuncName":"GetCounter","Params":[],"Results":[{"Name":".res.0","Type":"int","Value":""}]},{"FuncName":"Inc","Params":[],"Results":[{"Name":".res.0","Type":"int","Value":""}]}]`},
