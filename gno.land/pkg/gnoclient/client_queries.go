...
func (c *Client) Query(cfg QueryCfg) (*abci.ResultABCIQuery, error) {
...
func (c *Client) QueryAccount(addr crypto.Address) (*std.BaseAccount, *abci.ResultABCIQuery, error) {
	if err := c.validateRPCClient(); err != nil {
		return nil, nil, err
	}
...
func (c *Client) QueryAppVersion() (string, *abci.ResultABCIQuery, error) {
	if err := c.validateRPCClient(); err != nil {
		return "", nil, err
	}
...
func (c *Client) Render(pkgPath string, args string) (string, *abci.ResultABCIQuery, error) {
	if err := c.validateRPCClient(); err != nil {
		return "", nil, err
	}
...
func (c *Client) QEval(pkgPath string, expression string) (string, *abci.ResultABCIQuery, error) {
	if err := c.validateRPCClient(); err != nil {
		return "", nil, err
	}
