...
Implemented, landed in commit `acd01fa29`. Third and — on the evidence below —
final shape. Supersedes both the strict construction pin and the origin guard;
see *Alternatives* for why each leaves a hole.
