# ADR: A treasury payment executes what its proposal page showed

## Status

Implemented, landed in #6164.
...
`r/gov/dao/impl/v0` grew. The file's own NOTE anticipates this.
