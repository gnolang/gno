...
[here](https://github.com/tendermint/classic/blob/master/abci/cmd/abci-cli/abci-cli.go)
and looks like:
...
Golang](https://github.com/tendermint/classic/tree/master/abci/server). See the
...
example directory](https://github.com/tendermint/classic/tree/master/abci/example).
