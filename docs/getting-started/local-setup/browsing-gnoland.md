...
![gnodev](../../assets/getting-started/local-setup/browsing-gno-source-code/gnodev-start.gif)
...
[`http://localhost:8888`](http://localhost:8888), you will be able to see a local
version of the gno.land home page.
