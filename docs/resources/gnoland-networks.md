...
| Test7   | https://rpc.test8.testnets.gno.land:443 | `test8`   |
...
- **Timeliness of code:**
  - Pre-deployed packages and realms are at release tag [chain/test8](https://github.com/gnolang/gno/releases/tag/chain%2Ftest8.0)
- **Intended purpose**
