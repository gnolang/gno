...
The Banker's main purpose is to handle balance changes of [native coins](./02-coin.md) within Gno chains. This includes issuance, transfers, and burning of coins. 
...
The Banker API can be found under the `std` package [reference](../../07-reference/03-stdlibs/01-std/02-banker.md).
