...
haven't [premined a balance beforehand](../../../02-getting-started/03-local-setup/premining-balances.md).
...
Ensure the faucet account will have enough funds by [premining its balance](../../../02-getting-started/03-local-setup/premining-balances.md) to a high value.
...
can [run the local blockchain node](../../../02-getting-started/03-local-setup/setting-up-a-local-chain.md).
