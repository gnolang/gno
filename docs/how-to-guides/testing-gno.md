...
- **`gno` set up. Reference the [Installation](../getting-started/local-setup/README.md#3-installing-other-gno-tools) guide
  for steps**
...
in the [Standard Library](../concepts/stdlibs/README.md) reference section.
