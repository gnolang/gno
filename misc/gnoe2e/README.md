...
- `poisoned_dependent.txtar`: a package whose dependency is still parked keeps its chance to deploy, while one
  importing a path submitted nowhere stays rejected.
