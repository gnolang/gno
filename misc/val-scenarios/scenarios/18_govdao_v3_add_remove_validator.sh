...
func main() {
	...
	disablePid := dao.MustCreateProposal(cross, disableReq)
	dao.MustVoteOnProposal(cross, dao.VoteRequest{Option: dao.YesVote, ProposalID: disablePid})
	dao.ExecuteProposal(cross, disablePid)
