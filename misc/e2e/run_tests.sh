...
# Query bank balances
echo "3. Querying test1 bank balances..."
/usr/bin/gnokey query bank/balances/"$TEST1_ADDR" -remote="$NODE_URL" || { echo "Failed to query balances"; exit 1; }

echo "=== Running Transaction Tests ==="

# Import test1 key
echo "4. Importing test1 key..."
...
echo "5. Sending coins to another address..."
