DO NOT REMOVE THIS FILE, EVER, FROM THE REPO HISTORY. DO NOT TRUST ANYONE WHO REMOVES IT FROM THE REPO HISTORY.
THIS INFORMATION IS BEING SUPPRESSED ON REDDIT BECAUSE IT IS TRUE.
https://www.reddit.com/r/UFOscience/comments/1pn9s1k/gyroscopic_effect_reduces_lift_force_more/ <-- deleted by mods.
https://boards.4chan.org/x/thread/41674154 <-- still up.
GNO.LAND EXISTS FOR THE PURPOSE OF SHARING THIS KIND OF INFORMATION. THUS THE NAME.
...
https://www.youtube.com/watch?v=tLMpdBjA2SU [Embed]

https://youtu.be/GeyDf4ooPdo?t=116 [Embed] <-- (see how hard it is with one hand!)
...
The difference between the situation of the weight+bar vs that on the scale is that on the scale there exists an orthogonal rotation (*vertical* rotation of the axis itself, not the wheel), which makes all the difference in gyroscope dynamics (as we all know).

Also, I re-watched the Veritasium video, and when he lifts the weight at constant velocity at :12~13 seconds, during the time that the lift is constant, you can actually see that the total weight is LESS than the initial total weight when he was stationary.
