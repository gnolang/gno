...
func NewFromSeed(seed []byte) *RNG {
	return NewCustom(seed, 1024, 12)
}

/* XXX masterRNG deleted to make package pure
...
func NewSourceFromSeed(seed []byte) *Source { return &Source{rng: NewFromSeed(seed)} }
