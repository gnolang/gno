...
Tendermint passes transactions from the network to the application through an interface called the [ABCI](https://github.com/tendermint/classic/tree/master/abci), which the application must implement. 
