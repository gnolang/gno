...
// Examples
//
// - [Tendermint](https://github.com/tendermint/classic/blob/master/rpc/core/routes.go)
// - [tm-monitor](https://github.com/tendermint/classic/blob/master/tools/tm-monitor/rpc.go)
package rpc
