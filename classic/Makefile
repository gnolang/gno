...
LD_FLAGS = -X github.com/tendermint/classic/version.GitCommit=`git rev-parse --short=8 HEAD` -s -w
...
draw_deps:
	...
	@goviz -i github.com/tendermint/classic/cmd/tendermint -d 3 | dot -Tpng -o dependency-graph.png
