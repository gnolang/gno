...
- Do NOT add `Co-Authored-By` lines for AI tools in commits — they are legally misleading and carry no useful information. Disclose AI usage in the PR description instead.
