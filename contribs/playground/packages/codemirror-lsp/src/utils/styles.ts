...
export const classNames = {
  ...
  diagnostic: {
    message: 'cm-diagnostic--message',
    code: 'cm-diagnostic--code',
  },
}
...
export const coreStyles: StyleSpec = {
  ...
  [`& .${classNames.diagnostic.message}`]: {
    'white-space': 'pre-wrap',
  },
  [`& .${classNames.diagnostic.code}`]: {
    opacity: '0.6',
    paddingLeft: '6px',
  },
}
...
/**
 * Creates LSP plugin theme.
 */
export const createPluginTheme = (opts?: PluginThemeOptions): PluginTheme => {
