			...
			case *BinaryExpr:
				...
				if lic {
					...
					if isUntyped(rcx.T) {
						...
						//		checkOperandWithOp(store, last, &n.Right, ilnt, n.Op, Binary)
			...
			case *AssignStmt:
				...
				if n.Op == DEFINE {
					...
					if len(n.Lhs) > len(n.Rhs) {
						...
						checkOperandWithOp(store, last, &n.Lhs[0], lt, n.Op, Assign)
