...
func readSourceFile(file string, _ Store) (string, error) {
	...
	// TODO: Try to extract from store if available
	// For now, we'll just return an error since Store doesn't have a direct API for this
	// We would need to enhance Store interface
