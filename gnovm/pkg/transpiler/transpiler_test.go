...
import "gno.land/r/gnoland/users"
...
import "github.com/gnolang/gno/examples/gno.land/r/gnoland/users"
			...
			expectedImports: []*ast.ImportSpec{
				{
					Path: &ast.BasicLit{
						ValuePos: 21,
						Kind:     9,
						Value:    `"github.com/gnolang/gno/examples/gno.land/r/gnoland/users"`,
					},
				},
			},
		},
