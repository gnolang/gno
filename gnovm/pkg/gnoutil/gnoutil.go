...
// DefaultRootDir determines the default root directory.
// This is the value of os.Getenv("GNOROOT"), if present. Otherwise, it falls back
// to the directory for github.com/gnolang/gno, as resolved by "go list".
