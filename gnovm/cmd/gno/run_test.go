	...
	tc := []testMainCase{
		...
		},
		{
			...
			stderrShouldContain: func() string {
				lines := []string{
					"../../tests/integ/several-files-multiple-errors/file2.gno:3:5: expected 'IDENT', found '{' (panic=+go/scanner.ErrorList) (code=lintGnoError)",
					"../../tests/integ/several-files-multiple-errors/file2.gno:5:1: expected type, found '}' (panic=+go/scanner.ErrorList) (code=lintGnoError)",
					"../../tests/integ/several-files-multiple-errors/main.gno:5:5: expected ';', found example (panic=+go/scanner.ErrorList) (code=lintGnoError)",
					"../../tests/integ/several-files-multiple-errors/main.gno:6:2: expected '}', found 'EOF' (panic=+go/scanner.ErrorList) (code=lintGnoError)",
				}
