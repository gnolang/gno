...
var nativeFuncs = [...]NativeFunc{
	...
	},
	{
		...
		func(m *gno.Machine) {
			...
			r0, r1 := libs_std.X_getParamString(
				m,
				p0)
	...
	},
	{
		...
		func(m *gno.Machine) {
			...
			r0, r1 := libs_std.X_getParamInt64(
				m,
				p0)
	...
	},
	{
		...
		func(m *gno.Machine) {
			...
			r0, r1 := libs_std.X_getParamUint64(
				m,
				p0)
	...
	},
	{
		...
		func(m *gno.Machine) {
			...
			r0, r1 := libs_std.X_getParamBytes(
				m,
				p0)
	...
	},
	{
		...
		func(m *gno.Machine) {
			...
			r0, r1 := libs_std.X_getParamStrings(
				m,
				p0)
