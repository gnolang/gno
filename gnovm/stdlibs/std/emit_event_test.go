...
func TestEmit_ContractInteraction(t *testing.T) {
	...
	expected := `[{"type":"foo","attrs":[{"key":"k1","value":"v1"},{"key":"k2","value":"v2"}],"pkg_path":"","func":"","orig_caller":""},{"type":"qux","attrs":[{"key":"bar","value":"baz"}],"pkg_path":"","func":"","orig_caller":""}]`
...
func TestEmit_Iteration(t *testing.T) {
	...
	builder.WriteString("[")
	for i := 0; i < 10; i++ {
		builder.WriteString(`{"type":"bar","attrs":[{"key":"qux","value":"value1"}],"pkg_path":"","func":"","orig_caller":""},`)
	}
...
func TestEmit_ComplexInteraction(t *testing.T) {
	...
	expected := `[{"type":"ForLoopEvent","attrs":[{"key":"iteration","value":"0"},{"key":"key","value":"value"}],"pkg_path":"","func":"","orig_caller":""},{"type":"ForLoopEvent","attrs":[{"key":"iteration","value":"1"},{"key":"key","value":"value"}],"pkg_path":"","func":"","orig_caller":""},{"type":"ForLoopEvent","attrs":[{"key":"iteration","value":"2"},{"key":"key","value":"value"}],"pkg_path":"","func":"","orig_caller":""},{"type":"ForLoopCompletionEvent","attrs":[{"key":"count","value":"3"}],"pkg_path":"","func":"","orig_caller":""},{"type":"CallbackEvent","attrs":[{"key":"key1","value":"value1"},{"key":"key2","value":"value2"}],"pkg_path":"","func":"","orig_caller":""},{"type":"CallbackCompletionEvent","attrs":[{"key":"key","value":"value"}],"pkg_path":"","func":"","orig_caller":""},{"type":"DeferEvent","attrs":[{"key":"key1","value":"value1"},{"key":"key2","value":"value2"}],"pkg_path":"","func":"","orig_caller":""}]`
	assert.Equal(t, expected, string(res))
}
