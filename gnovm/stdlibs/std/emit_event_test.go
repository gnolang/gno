...
func TestEmit_ContractInteraction(t *testing.T) {
	...
	expected := `[{"orig_caller":"","prev":{"prev_pkg_path":"","prev_pkg_addr":""},"prev_func":"","pkg_path":"","func":"","type":"foo","attrs":[{"key":"k1","value":"v1"},{"key":"k2","value":"v2"}]},{"orig_caller":"","prev":{"prev_pkg_path":"","prev_pkg_addr":""},"prev_func":"","pkg_path":"","func":"","type":"qux","attrs":[{"key":"bar","value":"baz"}]}]`
...
func TestEmit_Iteration(t *testing.T) {
	...
	builder.WriteString("[")
	for i := 0; i < 10; i++ {
		builder.WriteString(`{"orig_caller":"","prev":{"prev_pkg_path":"","prev_pkg_addr":""},"prev_func":"","pkg_path":"","func":"","type":"bar","attrs":[{"key":"qux","value":"value1"}]},`)
	}
...
func TestEmit_ComplexInteraction(t *testing.T) {
	...
	expected := `[{"orig_caller":"","prev":{"prev_pkg_path":"","prev_pkg_addr":""},"prev_func":"","pkg_path":"","func":"","type":"ForLoopEvent","attrs":[{"key":"iteration","value":"0"},{"key":"key","value":"value"}]},{"orig_caller":"","prev":{"prev_pkg_path":"","prev_pkg_addr":""},"prev_func":"","pkg_path":"","func":"","type":"ForLoopEvent","attrs":[{"key":"iteration","value":"1"},{"key":"key","value":"value"}]},{"orig_caller":"","prev":{"prev_pkg_path":"","prev_pkg_addr":""},"prev_func":"","pkg_path":"","func":"","type":"ForLoopEvent","attrs":[{"key":"iteration","value":"2"},{"key":"key","value":"value"}]},{"orig_caller":"","prev":{"prev_pkg_path":"","prev_pkg_addr":""},"prev_func":"","pkg_path":"","func":"","type":"ForLoopCompletionEvent","attrs":[{"key":"count","value":"3"}]},{"orig_caller":"","prev":{"prev_pkg_path":"","prev_pkg_addr":""},"prev_func":"","pkg_path":"","func":"","type":"CallbackEvent","attrs":[{"key":"key1","value":"value1"},{"key":"key2","value":"value2"}]},{"orig_caller":"","prev":{"prev_pkg_path":"","prev_pkg_addr":""},"prev_func":"","pkg_path":"","func":"","type":"CallbackCompletionEvent","attrs":[{"key":"key","value":"value"}]},{"orig_caller":"","prev":{"prev_pkg_path":"","prev_pkg_addr":""},"prev_func":"","pkg_path":"","func":"","type":"DeferEvent","attrs":[{"key":"key1","value":"value1"},{"key":"key2","value":"value2"}]}]`
	assert.Equal(t, expected, string(res))
}
