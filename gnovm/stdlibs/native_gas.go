...
var calibratedNativeGas = []nativeGasEntry{
	...
	{Pkg: "chain/runtime", Fn: "objectID", Base: 552, SlopeIdx: -1, SlopeKind: SizeFlat},                                                                       // borrows chain.packageAddress's Base for the identical truncated-SHA256+bech32 derivation over a bounded preimage, above the ~527 fair floor its row implies. The store charges the RefValue deref separately
