...
var calibratedNativeGas = []nativeGasEntry{
	...
	{Pkg: "chain/runtime", Fn: "getRealmV3a", Base: 1003, Slope: 1319, SlopeIdx: -1, SlopeKind: SizeNumCallFrames},                                               // same shape as getRealm (one extra LastRealm check per frame is negligible)
