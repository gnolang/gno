...
Implemented, landed in #6164. Verified: gnolang unit + `-race`, sdk/vm gas, and
integration. (The only `TestFiles` failures are pre-existing `go/types`
golden-text diffs, present with and without this change.)
