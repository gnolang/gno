...
// GoTypeCheckError:
// line 18: impossible type switch case: int
// 	e (variable of interface type error) cannot have dynamic type int (missing method Error)
// line 26: multiple defaults (first at main/switch6.go:25:2)
// line 30: multiple defaults (first at main/switch6.go:29:2)
// line 44: impossible type switch case: X
// 	i (variable of interface type I) cannot have dynamic type X (method Foo has pointer receiver)
