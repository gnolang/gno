...
// GoTypeCheckError:
// line 12: invalid copy: argument must be a slice
// line 13: invalid copy: argument must be a slice
// line 14: invalid operation: 1 + true (mismatched types untyped int and untyped bool)
