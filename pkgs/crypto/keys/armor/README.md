...
```bash
go test -v --bench github.com/gnolang/gno/pkgs/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/gnolang/gno/pkgs/crypto/keys/mintkey
...
PASS
ok  	github.com/gnolang/gno/pkgs/crypto/keys/mintkey	12.093s
```
